...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_QWERTY]  = { ENCODER_CCW_CW(XXXXXXX, XXXXXXX),   ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [_LOWER]   = { ENCODER_CCW_CW(XXXXXXX, XXXXXXX),   ENCODER_CCW_CW(XXXXXXX, XXXXXXX) },
    [_RAISE]   = { ENCODER_CCW_CW(XXXXXXX, XXXXXXX),   ENCODER_CCW_CW(KC_BRIU, KC_BRID) },
    [_ADJUST]  = { ENCODER_CCW_CW(XXXXXXX, XXXXXXX),   ENCODER_CCW_CW(UG_VALU, UG_VALD) },
